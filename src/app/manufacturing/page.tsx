                                        ...
                                        <tr key={record.id}>
                                            ...
                                            <td>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <DeleteButton id={record.id} action={deleteManufacturing} label="Delete" className="text-xs bg-red-500/20 text-red-400 px-3 py-1 rounded hover:bg-red-500/30 transition-colors font-medium" />
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
